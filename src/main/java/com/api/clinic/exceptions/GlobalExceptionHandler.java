...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(RelatedEntitiesExceptions.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<Object> handleDataBindingViolationException(
            RelatedEntitiesExceptions relatedEntitiesExceptions,
            WebRequest request) {
        log.error("Failed to save entity with associated data", relatedEntitiesExceptions);
        return buildErrorResponse(
                relatedEntitiesExceptions,
                HttpStatus.CONFLICT,
                request);
    }
